...
const AccountSettings = () => {
  ...
  return (
    <>
      ...
      <div style={{ padding: 10, backgroundColor: "#a7bcff" }}>
        ...
        >
          <div style={{display: "flex", gap: 10}}>
            <img src="https://www.elmueble.com/medio/2022/02/11/aranzazu-diaz-huerta_203d6a05_120x120.jpg" alt="" />
          ...
          <div>
            ...
            <div>
              ...
              <div style={{width:"90%", height:100, margin:"auto", overflowY: "scroll", backgroundColor: "lightgray", borderRadius: 5}}>
                 <h4 style={{paddingBottom: 5, margin: 5}}>Bio:</h4>
              </div>
      ...
      {isOpenPost && <PostModal setIsOpen={setIsOpenPost} postData={modelPosts} />}
        ...
        >
          <div>
            ...
            <div style={{display: "grid", gridTemplateColumns: "repeat(3, 1fr)",  gridColumnGap: "0px", gridRowGap: "0px"}}>
              ...
              <div style={{width:150, backgroundColor: "white", padding: 5, margin:5, borderRadius: 5}} onClick={()=>openPost()}>
                <img style={{width: "100%", borderRadius: 10}} src="https://media.gettyimages.com/id/1317804578/photo/one-businesswoman-headshot-smiling-at-the-camera.jpg?s=612x612&w=gi&k=20&c=tFkDOWmEyqXQmUHNxkuR5TsmRVLi5VZXYm3mVsjee0E=" alt="" />
